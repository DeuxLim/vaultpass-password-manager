...
- ✅ Billing integration (provider + webhooks + entitlement enforcement) (`docs/billing-integration.md`, `docs/billing-stripe.md`, `sql/migrations/013_add_user_entitlements.sql`).
